...
public class BuildCommand extends AbstractCommand {
    ...
    @Option(names = {"--login-directory", "-lsdir"}, description = "Login directory")
    private String loginDirectory;
    
    @Option(names = {"--game-directory", "-gsdir"}, description = "Game directory")
    private String gameDirectory;
    
    @Option(names = {"--datapack-directory", "-dpdir"}, description = "DataPack directory")
    private String datapackDirectory;
    
    @Option(names = {"--skip-tests", "-st"}, defaultValue = "true", description = "Skip Tests")
    private boolean skipTests;

    public BuildCommand() {
        this.loginDirectory = DEFAULT_LOGIN_SOURCE_DIR;
        this.gameDirectory = DEFAULT_GAME_SOURCE_DIR;
        this.datapackDirectory = DEFAULT_DATAPACK_SOURCE_DIR;
    }
