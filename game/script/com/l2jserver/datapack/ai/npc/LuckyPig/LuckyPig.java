 ...
 */
package com.l2jserver.datapack.ai.npc.LuckyPig;
...
import static com.l2jserver.gameserver.config.Configuration.LuckyPig;
...
{
	private static final Logger _log = Logger.getLogger(LuckyPig.class.getName()); // Инициализация логгера
	...
	// Misc              //FIX DOUBLE
	private static final int LUCKY_PIG_CHANCE = LuckyPig().LuckyPigChance();
	//@formatter:off
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		else
		{
			...
			if (LuckyPig().EventLuckyPigEnabled() && LuckyPidChance/* || killer.isGM()*/)
			{
				...
				{
					minAdena = LuckyPig().LuckyPigMediumAdena();
					luckyPigId = LUCKY_PIG_MEDIUM;
				}
				else
				{
					minAdena = LuckyPig().LuckyPigTopAdena();
