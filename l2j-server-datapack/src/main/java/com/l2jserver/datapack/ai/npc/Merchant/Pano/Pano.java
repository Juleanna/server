 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Pano;
...
* @version 2.6.3.0
*/
public class Pano extends MerchantForChaotic {
	...
	private static final int npcId = 30078;
	...
	public Pano() {
		...
		super.fnHi = "pano001.htm";
		super.fnYouAreChaotic = "pano006.htm";
	}
}