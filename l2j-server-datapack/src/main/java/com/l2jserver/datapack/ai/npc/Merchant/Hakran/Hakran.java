 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Hakran;
...
* @version 2.6.3.0
*/
public class Hakran extends Merchant {
	...
	private static final int npcId = 31339;
	...
	public Hakran() {
		...
		super.fnHi = "amulet_seller_hakran001.htm";
		super.fnYouAreChaotic = "amulet_seller_hakran006.htm";
	}
}