 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Payel;
...
* @version 2.6.3.0
*/
public class Payel extends Merchant {
	...
	private static final int npcId = 30893;
	...
	public Payel() {
		...
		super.fnHi = "trader_payel001.htm";
		super.fnYouAreChaotic = "trader_payel006.htm";
	}
}