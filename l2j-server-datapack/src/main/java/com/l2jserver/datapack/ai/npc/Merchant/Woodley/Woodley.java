 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Woodley;
...
* @version 2.6.3.0
*/
public class Woodley extends Merchant {
	...
	private static final int npcId = 30838;
	...
	public Woodley() {
		...
		super.fnHi = "trader_woodley001.htm";
		super.fnYouAreChaotic = "trader_woodley006.htm";
	}
}