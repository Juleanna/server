 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Rumba;
...
* @version 2.6.3.0
*/
public class Rumba extends Merchant {
	...
	private static final int npcId = 31980;
	...
	public Rumba() {
		...
		super.fnHi = "amulet_seller_rumba001.htm";
		super.fnYouAreChaotic = "amulet_seller_rumba006.htm";
	}
}