 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Neagel;
...
* @version 2.6.3.0
*/
public class Neagel extends Merchant {
	...
	private static final int npcId = 32167;
	...
	public Neagel() {
		...
		super.fnHi = "trader_neagel001.htm";
		super.fnYouAreChaotic = "trader_neagel006.htm";
	}
}