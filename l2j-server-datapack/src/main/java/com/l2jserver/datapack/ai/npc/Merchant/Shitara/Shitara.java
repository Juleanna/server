 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Shitara;
...
* @version 2.6.3.0
*/
public class Shitara extends Merchant {
	...
	private static final int npcId = 31429;
	...
	public Shitara() {
		...
		super.fnHi = "amulet_seller_shitara001.htm";
		super.fnYouAreChaotic = "amulet_seller_shitara006.htm";
	}
}