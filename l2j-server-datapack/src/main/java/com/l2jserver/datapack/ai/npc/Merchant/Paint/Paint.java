 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Paint;
...
* @version 2.6.3.0
*/
public class Paint extends MerchantForNewbie {
	...
	private static final int npcId = 30136;
	...
	public Paint() {
		...
		super.fnHi = "paint001.htm";
		super.fnYouAreChaotic = "paint006.htm";
	}
}