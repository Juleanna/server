 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Lorenzo;
...
* @version 2.6.3.0
*/
public class Lorenzo extends Merchant {
	...
	private static final int npcId = 30840;
	...
	public Lorenzo() {
		...
		super.fnHi = "trader_lorenzo001.htm";
		super.fnYouAreChaotic = "trader_lorenzo006.htm";
	}
}