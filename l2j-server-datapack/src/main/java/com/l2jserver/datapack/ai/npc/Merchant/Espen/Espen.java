 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Espen;
...
* @version 2.6.3.0
*/
public class Espen extends Merchant {
	...
	private static final int npcId = 30890;
	...
	public Espen() {
		...
		super.fnHi = "trader_espen001.htm";
		super.fnYouAreChaotic = "trader_espen006.htm";
	}
}