 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Rouge;
...
* @version 2.6.3.0
*/
public class Rouge extends Merchant {
	...
	private static final int npcId = 31949;
	...
	public Rouge() {
		...
		super.fnHi = "trader_rouge001.htm";
		super.fnYouAreChaotic = "trader_rouge006.htm";
	}
}