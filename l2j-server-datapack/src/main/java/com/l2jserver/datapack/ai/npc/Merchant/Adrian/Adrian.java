 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Adrian;
...
* @version 2.6.3.0
*/
public class Adrian extends Merchant {
	...
	private static final int npcId = 31948;
	...
	public Adrian() {
		...
		super.fnHi = "trader_adrian001.htm";
		super.fnYouAreChaotic = "trader_adrian006.htm";
	}
}