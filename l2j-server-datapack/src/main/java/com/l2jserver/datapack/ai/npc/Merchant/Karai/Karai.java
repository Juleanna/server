 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Karai;
...
* @version 2.6.3.0
*/
public class Karai extends Merchant {
	...
	private static final int npcId = 31431;
	...
	public Karai() {
		...
		super.fnHi = "amulet_seller_karai001.htm";
		super.fnYouAreChaotic = "amulet_seller_karai006.htm";
	}
}