 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Aren;
...
* @version 2.6.3.0
*/
public class Aren extends Merchant {
	...
	private static final int npcId = 31416;
	...
	public Aren() {
		...
		super.fnHi = "scroll_seller_aren001.htm";
		super.fnYouAreChaotic = "scroll_seller_aren006.htm";
	}
}