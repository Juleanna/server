 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Sonia;
...
* @version 2.6.3.0
*/
public class Sonia extends Merchant {
	...
	private static final int npcId = 30062;
	...
	public Sonia() {
		...
		super.fnHi = "sonia001.htm";
		super.fnYouAreChaotic = "sonia006.htm";
	}
}