 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Candice;
...
* @version 2.6.3.0
*/
public class Candice extends Merchant {
	...
	private static final int npcId = 31305;
	...
	public Candice() {
		...
		super.fnHi = "trader_candice001.htm";
		super.fnYouAreChaotic = "trader_candice006.htm";
	}
}