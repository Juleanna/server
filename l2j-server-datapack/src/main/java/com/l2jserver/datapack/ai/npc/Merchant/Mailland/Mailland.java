 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Mailland;
...
* @version 2.6.3.0
*/
public class Mailland extends Merchant {
	...
	private static final int npcId = 31950;
	...
	public Mailland() {
		...
		super.fnHi = "trader_mailland001.htm";
		super.fnYouAreChaotic = "trader_mailland006.htm";
	}
}