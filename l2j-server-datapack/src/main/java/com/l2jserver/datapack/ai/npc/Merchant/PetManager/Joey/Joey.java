 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.PetManager.Joey;
...
* @version 2.6.3.0
*/
public class Joey extends PetManager {
	...
	private static final int npcId = 30830;
	...
	public Joey() {
		...
		super.fnHi = "pet_manager_joey001.htm";
		super.fnYouAreChaotic = "pet_manager_joey006.htm";
	}
}