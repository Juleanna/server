 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Iria;
...
* @version 2.6.3.0
*/
public class Iria extends MerchantForNewbie {
	...
	private static final int npcId = 30135;
	...
	public Iria() {
		...
		super.fnHi = "iria001.htm";
		super.fnYouAreChaotic = "iria006.htm";
	}
}