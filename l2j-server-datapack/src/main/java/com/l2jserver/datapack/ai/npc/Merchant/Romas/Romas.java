 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Romas;
...
* @version 2.6.3.0
*/
public class Romas extends Merchant {
	...
	private static final int npcId = 31423;
	...
	public Romas() {
		...
		super.fnHi = "scroll_seller_romas001.htm";
		super.fnYouAreChaotic = "scroll_seller_romas006.htm";
	}
}