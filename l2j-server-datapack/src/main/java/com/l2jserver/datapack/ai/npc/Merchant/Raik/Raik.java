 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Raik;
...
* @version 2.6.3.0
*/
public class Raik extends Merchant {
	...
	private static final int npcId = 31667;
	...
	public Raik() {
		...
		super.fnHi = "amulet_seller_raik001.htm";
		super.fnYouAreChaotic = "amulet_seller_raik006.htm";
	}
}