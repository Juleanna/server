 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Uno;
...
* @version 2.6.3.0
*/
public class Uno extends MerchantForNewbie {
	...
	private static final int npcId = 30147;
	...
	public Uno() {
		...
		super.fnHi = "uno001.htm";
		super.fnYouAreChaotic = "uno006.htm";
	}
}