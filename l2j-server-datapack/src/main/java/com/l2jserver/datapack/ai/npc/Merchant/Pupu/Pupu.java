 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Pupu;
...
* @version 2.6.3.0
*/
public class Pupu extends Merchant {
	...
	private static final int npcId = 31952;
	...
	public Pupu() {
		...
		super.fnHi = "trader_pupu001.htm";
		super.fnYouAreChaotic = "trader_pupu006.htm";
	}
}