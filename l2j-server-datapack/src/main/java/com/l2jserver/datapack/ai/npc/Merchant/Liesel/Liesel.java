 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Liesel;
...
* @version 2.6.3.0
*/
public class Liesel extends Merchant {
	...
	private static final int npcId = 31263;
	...
	public Liesel() {
		...
		super.fnHi = "trader_liesel001.htm";
		super.fnYouAreChaotic = "trader_liesel006.htm";
	}
}