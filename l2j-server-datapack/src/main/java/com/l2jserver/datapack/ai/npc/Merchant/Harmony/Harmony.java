 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Harmony;
...
* @version 2.6.3.0
*/
public class Harmony extends Merchant {
	...
	private static final int npcId = 30254;
	...
	public Harmony() {
		...
		super.fnHi = "trader_harmony001.htm";
		super.fnYouAreChaotic = "trader_harmony006.htm";
	}
}