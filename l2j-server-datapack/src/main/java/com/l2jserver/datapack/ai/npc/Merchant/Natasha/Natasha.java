 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Natasha;
...
* @version 2.6.3.0
*/
public class Natasha extends Merchant {
	...
	private static final int npcId = 31306;
	...
	public Natasha() {
		...
		super.fnHi = "trader_natasha001.htm";
		super.fnYouAreChaotic = "trader_natasha006.htm";
	}
}