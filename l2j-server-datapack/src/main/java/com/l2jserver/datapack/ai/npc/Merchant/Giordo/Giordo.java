 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Giordo;
...
* @version 2.6.3.0
*/
public class Giordo extends Merchant {
	...
	private static final int npcId = 31441;
	...
	public Giordo() {
		...
		super.fnHi = "mineral_trader_giordo001.htm";
		super.fnYouAreChaotic = "mineral_trader_giordo006.htm";
	}
}