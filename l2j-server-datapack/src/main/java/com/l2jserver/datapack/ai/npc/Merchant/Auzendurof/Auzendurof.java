 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Auzendurof;
...
* @version 2.6.3.0
*/
public class Auzendurof extends Merchant {
	...
	private static final int npcId = 31945;
	...
	public Auzendurof() {
		...
		super.fnHi = "trader_auzendurof001.htm";
		super.fnYouAreChaotic = "trader_auzendurof006.htm";
	}
}