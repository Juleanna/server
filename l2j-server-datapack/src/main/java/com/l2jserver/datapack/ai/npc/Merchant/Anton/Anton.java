 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Anton;
...
* @version 2.6.3.0
*/
public class Anton extends Merchant {
	...
	private static final int npcId = 31338;
	...
	public Anton() {
		...
		super.fnHi = "scroll_seller_anton001.htm";
		super.fnYouAreChaotic = "scroll_seller_anton006.htm";
	}
}