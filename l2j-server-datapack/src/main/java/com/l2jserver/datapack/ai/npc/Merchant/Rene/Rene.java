 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Rene;
...
* @version 2.6.3.0
*/
public class Rene extends Merchant {
	...
	private static final int npcId = 31261;
	...
	public Rene() {
		...
		super.fnHi = "trader_rene001.htm";
		super.fnYouAreChaotic = "trader_rene006.htm";
	}
}