 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Terava;
...
* @version 2.6.3.0
*/
public class Terava extends Merchant {
	...
	private static final int npcId = 31291;
	...
	public Terava() {
		...
		super.fnHi = "amulet_seller_terava001.htm";
		super.fnYouAreChaotic = "amulet_seller_terava006.htm";
	}
}