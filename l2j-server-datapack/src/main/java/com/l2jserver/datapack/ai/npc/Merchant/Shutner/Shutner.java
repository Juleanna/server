 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Shutner;
...
* @version 2.6.3.0
*/
public class Shutner extends Merchant {
	...
	private static final int npcId = 31445;
	...
	public Shutner() {
		...
		super.fnHi = "mineral_trader_shutner001.htm";
		super.fnYouAreChaotic = "mineral_trader_shutner006.htm";
	}
}