 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Diyabu;

import com.l2jserver.datapack.ai.npc.Merchant.MerchantForFriend;

/**
* @author Charus
* @version 2.6.3.0
*/
public class Diyabu extends MerchantForFriend {
	...
	private static final int npcId = 31380;
	...
	public Diyabu() {
		...
		super.fnHi = "trader_diyabu001.htm";
		super.fnNoFriend = "trader_diyabu009.htm";
	}
}