 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Rolento;
...
* @version 2.6.3.0
*/
public class Rolento extends MerchantForChaotic {
	...
	private static final int npcId = 30437;
	...
	public Rolento() {
		...
		super.fnHi = "trader_rolento001.htm";
		super.fnYouAreChaotic = "trader_rolento006.htm";
	}
}