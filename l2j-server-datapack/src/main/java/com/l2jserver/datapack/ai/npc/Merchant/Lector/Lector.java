 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Lector;
...
* @version 2.6.3.0
*/
public class Lector extends MerchantForNewbie {
	...
	private static final int npcId = 30001;
	...
	public Lector() {
		...
		super.fnHi = "lector001.htm";
		super.fnYouAreChaotic = "lector006.htm";
	}
}