 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Rahel;
...
* @version 2.6.3.0
*/
public class Rahel extends Merchant {
	...
	private static final int npcId = 31973;
	...
	public Rahel() {
		...
		super.fnHi = "scroll_seller_rahel001.htm";
		super.fnYouAreChaotic = "scroll_seller_rahel006.htm";
	}
}