 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Helmut;
...
* @version 2.6.3.0
*/
public class Helmut extends Merchant {
	...
	private static final int npcId = 31258;
	...
	public Helmut() {
		...
		super.fnHi = "trader_helmut001.htm";
		super.fnYouAreChaotic = "trader_helmut006.htm";
	}
}