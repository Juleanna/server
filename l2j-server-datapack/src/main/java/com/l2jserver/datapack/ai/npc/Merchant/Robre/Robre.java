 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Robre;
...
* @version 2.6.3.0
*/
public class Robre extends Merchant {
	...
	private static final int npcId = 31946;
	...
	public Robre() {
		...
		super.fnHi = "trader_robre001.htm";
		super.fnYouAreChaotic = "trader_robre006.htm";
	}
}