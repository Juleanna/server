 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Leon;
...
* @version 2.6.3.0
*/
public class Leon extends Merchant {
	...
	private static final int npcId = 31256;
	...
	public Leon() {
		...
		super.fnHi = "trader_leon001.htm";
		super.fnYouAreChaotic = "trader_leon006.htm";
	}
}