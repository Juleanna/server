 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Hedinger;
...
* @version 2.6.3.0
*/
public class Hedinger extends Merchant {
	...
	private static final int npcId = 32883;
	...
	public Hedinger() {
		...
		super.fnHi = "recipe_trader_hedinger001.htm";
		super.fnYouAreChaotic = "recipe_trader_hedinger006.htm";
	}
}