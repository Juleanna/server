 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Violet;
...
* @version 2.6.3.0
*/
public class Violet extends MerchantForChaotic {
	...
	private static final int npcId = 31386;
	...
	public Violet() {
		...
		super.fnHi = "day_violet001.htm";
		super.fnYouAreChaotic = "day_violet006.htm";
	}
}