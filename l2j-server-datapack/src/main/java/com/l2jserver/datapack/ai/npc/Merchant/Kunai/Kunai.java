 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Kunai;
...
* @version 2.6.3.0
*/
public class Kunai extends MerchantForNewbie {
	...
	private static final int npcId = 30559;
	...
	public Kunai() {
		...
		super.fnHi = "trader_kunai001.htm";
		super.fnYouAreChaotic = "trader_kunai006.htm";
	}
}