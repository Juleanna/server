 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Jouge;
...
* @version 2.6.3.0
*/
public class Jouge extends Merchant {
	...
	private static final int npcId = 31951;
	...
	public Jouge() {
		...
		super.fnHi = "trader_jouge001.htm";
		super.fnYouAreChaotic = "trader_jouge006.htm";
	}
}