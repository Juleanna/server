 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Acellopy;
...
* @version 2.6.3.0
*/
public class Acellopy extends Merchant {
	...
	private static final int npcId = 30313;
	...
	public Acellopy() {
		...
		super.fnHi = "trader_acellopy001.htm";
		super.fnYouAreChaotic = "trader_acellopy006.htm";
	}
}