 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Desian;
...
* @version 2.6.3.0
*/
public class Desian extends Merchant {
	...
	private static final int npcId = 32876;
	...
	public Desian() {
		...
		super.fnHi = "recipe_trader_desian001.htm";
		super.fnYouAreChaotic = "recipe_trader_desian006.htm";
	}
}