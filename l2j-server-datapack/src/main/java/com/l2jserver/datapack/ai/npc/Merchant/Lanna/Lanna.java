 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Lanna;
...
* @version 2.6.3.0
*/
public class Lanna extends Merchant {
	...
	private static final int npcId = 31440;
	...
	public Lanna() {
		...
		super.fnHi = "mineral_trader_lanna001.htm";
		super.fnYouAreChaotic = "mineral_trader_lanna006.htm";
	}
}