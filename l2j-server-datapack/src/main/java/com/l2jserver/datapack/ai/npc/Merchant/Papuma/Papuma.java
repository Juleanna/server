 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Papuma;
...
* @version 2.6.3.0
*/
public class Papuma extends Merchant {
	...
	private static final int npcId = 30561;
	...
	public Papuma() {
		...
		super.fnHi = "trader_papuma001.htm";
		super.fnYouAreChaotic = "trader_papuma006.htm";
	}
}