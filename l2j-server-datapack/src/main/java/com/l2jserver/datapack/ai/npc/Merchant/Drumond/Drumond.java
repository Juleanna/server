 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Drumond;
...
* @version 2.6.3.0
*/
public class Drumond extends Merchant {
	...
	private static final int npcId = 31300;
	...
	public Drumond() {
		...
		super.fnHi = "trader_drumond001.htm";
		super.fnYouAreChaotic = "trader_drumond006.htm";
	}
}