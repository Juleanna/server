 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Erinu;
...
* @version 2.6.3.0
*/
public class Erinu extends MerchantForNewbie {
	...
	private static final int npcId = 32164;
	...
	public Erinu() {
		...
		super.fnHi = "trader_erinu001.htm";
		super.fnYouAreChaotic = "trader_erinu006.htm";
	}
}