 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Elliany;
...
public class Elliany extends Merchant {
	...
	private static final int npcId = 30091;
	...
	public Elliany() {
		...
		super.fnHi = "elliany001.htm";
		super.fnYouAreChaotic = "elliany006.htm";
	}
}