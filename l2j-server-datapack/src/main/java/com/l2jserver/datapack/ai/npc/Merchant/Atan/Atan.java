 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Atan;
...
* @version 2.6.3.0
*/
public class Atan extends MerchantForFriend {
	...
	private static final int npcId = 31373;
	...
	public Atan() {
		...
		super.fnHi = "trader_atan001.htm";
		super.fnNoFriend = "trader_atan009.htm";
	}
}