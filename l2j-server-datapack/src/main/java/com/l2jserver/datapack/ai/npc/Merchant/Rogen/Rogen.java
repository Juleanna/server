 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Rogen;
...
* @version 2.6.3.0
*/
public class Rogen extends Merchant {
	...
	private static final int npcId = 31439;
	...
	public Rogen() {
		...
		super.fnHi = "mineral_trader_rogen001.htm";
		super.fnYouAreChaotic = "mineral_trader_rogen006.htm";
	}
}