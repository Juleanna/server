 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Salient;
...
* @version 2.6.3.0
*/
public class Salient extends MerchantForChaotic {
	...
	private static final int npcId = 30436;
	...
	public Salient() {
		...
		super.fnHi = "trader_salient001.htm";
		super.fnYouAreChaotic = "trader_salient006.htm";
	}
}