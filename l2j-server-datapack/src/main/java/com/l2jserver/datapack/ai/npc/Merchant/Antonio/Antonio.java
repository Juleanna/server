 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Antonio;
...
* @version 2.6.3.0
*/
public class Antonio extends Merchant {
	...
	private static final int npcId = 31413;
	...
	public Antonio() {
		...
		super.fnHi = "scroll_seller_antonio001.htm";
		super.fnYouAreChaotic = "scroll_seller_antonio006.htm";
	}
}