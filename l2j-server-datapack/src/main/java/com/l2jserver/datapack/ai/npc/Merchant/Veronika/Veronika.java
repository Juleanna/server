 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Veronika;
...
* @version 2.6.3.0
*/
public class Veronika extends Merchant {
	...
	private static final int npcId = 31257;
	...
	public Veronika() {
		...
		super.fnHi = "trader_veronika001.htm";
		super.fnYouAreChaotic = "trader_veronika006.htm";
	}
}