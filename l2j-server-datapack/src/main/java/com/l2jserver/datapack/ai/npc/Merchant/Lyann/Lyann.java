 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Lyann;
...
* @version 2.6.3.0
*/
public class Lyann extends Merchant {
	...
	private static final int npcId = 32874;
	...
	public Lyann() {
		...
		super.fnHi = "recipe_trader_lyann001.htm";
		super.fnYouAreChaotic = "recipe_trader_lyann006.htm";
	}
}