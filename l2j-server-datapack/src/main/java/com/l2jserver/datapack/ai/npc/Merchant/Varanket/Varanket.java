 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Varanket;
...
* @version 2.6.3.0
*/
public class Varanket extends MerchantForNewbie {
	...
	private static final int npcId = 30294;
	...
	public Varanket() {
		...
		super.fnHi = "trader_varanket001.htm";
		super.fnYouAreChaotic = "trader_varanket006.htm";
	}
}