 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Ratriya;
...
* @version 2.6.3.0
*/
public class Ratriya extends Merchant {
	...
	private static final int npcId = 31421;
	...
	public Ratriya() {
		...
		super.fnHi = "scroll_seller_ratriya001.htm";
		super.fnYouAreChaotic = "scroll_seller_ratriya006.htm";
	}
}