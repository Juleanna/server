 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Lynn;
...
* @version 2.6.3.0
*/
public class Lynn extends Merchant {
	...
	private static final int npcId = 31414;
	...
	public Lynn() {
		...
		super.fnHi = "scroll_seller_lynn001.htm";
		super.fnYouAreChaotic = "scroll_seller_lynn006.htm";
	}
}