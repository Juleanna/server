 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Tahoo;
...
* @version 2.6.3.0
*/
public class Tahoo extends Merchant {
	...
	private static final int npcId = 32875;
	...
	public Tahoo() {
		...
		super.fnHi = "recipe_trader_tahoo001.htm";
		super.fnYouAreChaotic = "recipe_trader_tahoo006.htm";
	}
}