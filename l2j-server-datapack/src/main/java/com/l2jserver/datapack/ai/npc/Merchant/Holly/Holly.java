 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Holly;
...
* @version 2.6.3.0
*/
public class Holly extends Merchant {
	...
	private static final int npcId = 30839;
	...
	public Holly() {
		...
		super.fnHi = "trader_holly001.htm";
		super.fnYouAreChaotic = "trader_holly006.htm";
	}
}