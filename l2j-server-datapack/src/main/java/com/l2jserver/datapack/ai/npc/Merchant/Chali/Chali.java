 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Chali;
...
* @version 2.6.3.0
*/
public class Chali extends MerchantForNewbie {
	...
	private static final int npcId = 30517;
	...
	public Chali() {
		...
		super.fnHi = "trader_chali001.htm";
		super.fnYouAreChaotic = "trader_chali006.htm";
	}
}