 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Kc;
...
* @version 2.6.3.0
*/
public class Kc extends Merchant {
	...
	private static final int npcId = 30061;
	...
	public Kc() {
		...
		super.fnHi = "kc001.htm";
		super.fnYouAreChaotic = "kc006.htm";
	}
}