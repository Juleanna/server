 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.PetManager.Saroyan;
...
* @version 2.6.3.0
*/
public class Saroyan extends PetManager {
	...
	private static final BuySellList[] _sellList0 = new BuySellList[] {
		...
		new BuySellList(5189, 20, 0.000000, 0), // crimson_bloodfang
		new BuySellList(5190, 20, 0.000000, 0), // draconic_chopper
		new BuySellList(5191, 20, 0.000000, 0), // diabolic_grinder
		...
		new BuySellList(5184, 20, 0.000000, 0), // hatchlings_crimson_plate
		new BuySellList(5185, 20, 0.000000, 0), // hatchlings_draconic_plate
		new BuySellList(5186, 20, 0.000000, 0), // hatchlings_inferno_plate
		...
		new BuySellList(5179, 20, 0.000000, 0), // draconic_slicer
		new BuySellList(5180, 20, 0.000000, 0), // ophidian_lancer
		new BuySellList(5181, 20, 0.000000, 0), // diamond_drill
		...
		new BuySellList(5173, 20, 0.000000, 0), // blood_panzer_coat
		new BuySellList(5174, 20, 0.000000, 0), // ophidian_panzer_coat
		new BuySellList(5175, 20, 0.000000, 0), // inferno_panzer_coat
		...
		new BuySellList(9659, 20, 0.000000, 0), // enchanted_ceruberus_canine
		new BuySellList(9660, 20, 0.000000, 0), // oricalcum_canine
		new BuySellList(9661, 20, 0.000000, 0), // enchanted_fenril_canine
		...
		new BuySellList(9665, 20, 0.000000, 0), // black_mane_wolf_mithril_armor
		new BuySellList(9666, 20, 0.000000, 0), // black_mane_wolf_oriharukon_armor
		new BuySellList(9667, 20, 0.000000, 0), // black_mane_wolf_oricalcum_armor
	...
	private static final int npcId = 31954;
	...
	public Saroyan() {
		...
		super.fnHi = "pet_manager_saroyan001.htm";
		super.fnYouAreChaotic = "pet_manager_saroyan006.htm";
	}
}