 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Hans;
...
* @version 2.6.3.0
*/
public class Hans extends Merchant {
	...
	private static final int npcId = 31319;
	...
	public Hans() {
		...
		super.fnHi = "mineral_trader_hans001.htm";
		super.fnYouAreChaotic = "mineral_trader_hans006.htm";
	}
}