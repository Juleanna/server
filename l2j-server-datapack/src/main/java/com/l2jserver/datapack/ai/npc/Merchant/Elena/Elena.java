 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Elena;
...
* @version 2.6.3.0
*/
public class Elena extends Merchant {
	...
	private static final int npcId = 31284;
	...
	public Elena() {
		...
		super.fnHi = "scroll_seller_elena001.htm";
		super.fnYouAreChaotic = "scroll_seller_elena006.htm";
	}
}