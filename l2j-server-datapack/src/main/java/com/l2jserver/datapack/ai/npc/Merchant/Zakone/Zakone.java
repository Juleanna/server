 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Zakone;
...
* @version 2.6.3.0
*/
public class Zakone extends MerchantForNewbie {
	...
	private static final int npcId = 32165;
	...
	public Zakone() {
		...
		super.fnHi = "trader_zakone001.htm";
		super.fnYouAreChaotic = "trader_zakone006.htm";
	}
}