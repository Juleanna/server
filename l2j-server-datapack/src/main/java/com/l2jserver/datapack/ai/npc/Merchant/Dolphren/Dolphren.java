 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Dolphren;
...
* @version 2.6.3.0
*/
public class Dolphren extends Merchant {
	...
	private static final int npcId = 32880;
	...
	public Dolphren() {
		...
		super.fnHi = "recipe_trader_dolphren001.htm";
		super.fnYouAreChaotic = "recipe_trader_dolphren006.htm";
	}
}