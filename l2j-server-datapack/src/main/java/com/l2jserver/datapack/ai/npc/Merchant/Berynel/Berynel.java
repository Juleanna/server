 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Berynel;
...
* @version 2.6.3.0
*/
public class Berynel extends Merchant {
	...
	private static final int npcId = 31417;
	...
	public Berynel() {
		...
		super.fnHi = "scroll_seller_berynel001.htm";
		super.fnYouAreChaotic = "scroll_seller_berynel006.htm";
	}
}