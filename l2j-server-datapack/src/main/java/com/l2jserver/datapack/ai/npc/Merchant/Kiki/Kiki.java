 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Kiki;
...
* @version 2.6.3.0
*/
public class Kiki extends Merchant {
	...
	private static final int npcId = 31442;
	...
	public Kiki() {
		...
		super.fnHi = "mineral_trader_kiki001.htm";
		super.fnYouAreChaotic = "mineral_trader_kiki006.htm";
	}
}