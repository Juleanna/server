 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Urgal;
...
* @version 2.6.3.0
*/
public class Urgal extends Merchant {
	...
	private static final int npcId = 31427;
	...
	public Urgal() {
		...
		super.fnHi = "amulet_seller_urgal001.htm";
		super.fnYouAreChaotic = "amulet_seller_urgal006.htm";
	}
}