 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Vladimir;
...
* @version 2.6.3.0
*/
public class Vladimir extends Merchant {
	...
	private static final int npcId = 31302;
	...
	public Vladimir() {
		...
		super.fnHi = "trader_vladimir001.htm";
		super.fnYouAreChaotic = "trader_vladimir006.htm";
	}
}