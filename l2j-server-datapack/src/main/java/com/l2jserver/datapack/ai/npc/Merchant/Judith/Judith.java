 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Judith;
...
* @version 2.6.3.0
*/
public class Judith extends Merchant {
	...
	private static final int npcId = 31260;
	...
	public Judith() {
		...
		super.fnHi = "trader_judith001.htm";
		super.fnYouAreChaotic = "trader_judith006.htm";
	}
}