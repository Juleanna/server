 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Hittchi;
...
* @version 2.6.3.0
*/
public class Hittchi extends Merchant {
	...
	private static final int npcId = 31963;
	...
	public Hittchi() {
		...
		super.fnHi = "mineral_trader_hittchi001.htm";
		super.fnYouAreChaotic = "mineral_trader_hittchi006.htm";
	}
}