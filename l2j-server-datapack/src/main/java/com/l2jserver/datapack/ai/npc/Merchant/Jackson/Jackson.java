 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Jackson;
...
* @version 2.6.3.0
*/
public class Jackson extends MerchantForNewbie {
	...
	private static final int npcId = 30002;
	...
	public Jackson() {
		...
		super.fnHi = "jackson001.htm";
		super.fnYouAreChaotic = "jackson006.htm";
	}
}