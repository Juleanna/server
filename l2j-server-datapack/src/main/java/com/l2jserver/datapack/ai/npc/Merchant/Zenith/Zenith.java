 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Zenith;
...
* @version 2.6.3.0
*/
public class Zenith extends Merchant {
	...
	private static final int npcId = 32168;
	...
	public Zenith() {
		...
		super.fnHi = "trader_zenith001.htm";
		super.fnYouAreChaotic = "trader_zenith006.htm";
	}
}