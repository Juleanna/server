 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Tweety;
...
* @version 2.6.3.0
*/
public class Tweety extends MerchantForNewbie {
	...
	private static final int npcId = 30420;
	...
	public Tweety() {
		...
		super.fnHi = "tweety001.htm";
		super.fnYouAreChaotic = "tweety006.htm";
	}
}