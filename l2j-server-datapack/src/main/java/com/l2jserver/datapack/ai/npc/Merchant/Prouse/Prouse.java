 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Prouse;
...
* @version 2.6.3.0
*/
public class Prouse extends Merchant {
	...
	private static final int npcId = 32882;
	...
	public Prouse() {
		...
		super.fnHi = "recipe_trader_prouse001.htm";
		super.fnYouAreChaotic = "recipe_trader_prouse006.htm";
	}
}