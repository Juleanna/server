 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Sparky;
...
* @version 2.6.3.0
*/
public class Sparky extends Merchant {
	...
	private static final int npcId = 32878;
	...
	public Sparky() {
		...
		super.fnHi = "recipe_trader_sparky001.htm";
		super.fnYouAreChaotic = "recipe_trader_sparky006.htm";
	}
}