 ...
 */
package com.l2jserver.datapack.ai.npc.Merchant.Arodin;
...
* @version 2.6.3.0
*/
public class Arodin extends MerchantForNewbie {
	...
	private static final int npcId = 30207;
	...
	public Arodin() {
		...
		super.fnHi = "trader_arodin001.htm";
		super.fnYouAreChaotic = "trader_arodin006.htm";
	}
}